...
#execute_process(TARGET CMAKEoctave PRE_BUILD COMMAND ${MKOCTFILE} ${OCTARG} "${CMAKE_CURRENT_SOURCE_DIR}/testOctave.cpp")

#find_path(OCTAVE_INCLUDE_DIR octave/oct.h PATHS ${OCTAVE_INCDIR} ${OCTAVE_INCDIR}/.. )
find_path(OCTAVE_INCLUDE_DIR/octave/ PATHS ${OCTAVE_INCDIR} ${OCTAVE_INCDIR}/.. )
